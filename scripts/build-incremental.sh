...
case "$CHANGED" in
    ...
    *)
        ...
        ALL_SERVICES="${RUNTIME_SERVICES:-discord stt flan orchestrator bark monitoring testing guardrails}"
...
TOTAL_SERVICES=$(echo "${RUNTIME_SERVICES:-discord stt flan orchestrator bark monitoring testing guardrails}" | wc -w)
