...
1.  Update `BackgroundModelLoader` initialization to consume the new functions.
2.  Adjust logging to rely on structured data rather than ad-hoc messages.
3.  Write unit tests covering CPU/GPU availability, force download toggles, and error propagation.
