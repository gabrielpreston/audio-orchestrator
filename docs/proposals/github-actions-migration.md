...
-  **Align documentation and onboarding** — ensure future you can rediscover how automation works.
...
-  **Enforce and iterate** — let automation guard merges and drive continuous improvement.
