...
The result is a **continuous conversational control loop** where the AI listens, thinks, acts, and speaks—without manual input or switching modalities.
