...
class TestAdapterManager:
    ...
    def test_register_duplicate_input_adapter(self):
        ...
        with pytest.raises(ValueError, match="Input adapter 'discord_audio_input' is already registered"):
    ...
    def test_register_duplicate_output_adapter(self):
        ...
        with pytest.raises(ValueError, match="Output adapter 'discord_audio_output' is already registered"):
    ...
    def test_register_invalid_input_adapter(self):
        ...
        with pytest.raises(ValueError, match="Adapter must be an AudioInputAdapter instance"):
    ...
    def test_register_invalid_output_adapter(self):
        ...
        with pytest.raises(ValueError, match="Adapter must be an AudioOutputAdapter instance"):
