...
class DiscordAudioInputAdapter(AudioInputAdapter):
    ...
    async def start_capture(self) -> None:
        ...
        try:
            ...
            self._logger.error("Failed to start Discord audio capture", extra={"error": str(e)})
            raise
    ...
    async def stop_capture(self) -> None:
        ...
        try:
            ...
            self._logger.error("Error stopping Discord audio capture", extra={"error": str(e)})
            ...
            while self._is_capturing:
                try:
                    ...
                    self._logger.warning(
                        "Error getting audio data from Discord",
                        extra={"error": str(e)}
                    )
                    continue
    ...
    async def _capture_audio_loop(self) -> None:
        ...
        try:
            ...
            self._logger.error("Error in Discord audio capture loop", extra={"error": str(e)})
    ...
    async def health_check(self) -> dict[str, Any]:
        ...
        discord_health = {
            ...
            "capture_task_running": self._capture_task is not None and not self._capture_task.done()
        }
