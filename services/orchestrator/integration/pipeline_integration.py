...
class PipelineIntegration:
    ...
    async def start_processing(self, session_id: str) -> None:
        ...
        if self._is_processing:
            self._logger.warning(
                "Processing already started", extra={"session_id": session_id}
            )
            return
        ...
        try:
            ...
            self._logger.info(
                "Starting audio processing", extra={"session_id": session_id}
            )
    ...
    async def stop_processing(self, session_id: str) -> None:
        ...
        if not self._is_processing:
            self._logger.warning(
                "Processing not started", extra={"session_id": session_id}
            )
            return
        ...
        try:
            ...
            self._logger.info(
                "Audio processing stopped", extra={"session_id": session_id}
            )
    ...
    async def _process_audio_stream(
        ...
        try:
            ...
            self._logger.info(
                "Audio processing cancelled", extra={"session_id": session_id}
            )
            raise
        except Exception as e:
            self._logger.error(
