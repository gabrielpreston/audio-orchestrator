...
class TestWakeDetection:
    ...
    def test_wake_detection_bypass_when_disabled(self, wake_detector_disabled, sample_audio_segment):
    ...
    def test_wake_detection_logs_results(self, wake_detector_enabled, sample_audio_segment):
        ...
        with patch.object(wake_detector_enabled, '_detect_audio', return_value=None), \
    ...
    @pytest.mark.component
    def test_wake_detection_bypass_logs_enabled_state(self, wake_detector_disabled, sample_audio_segment):
    ...
    def test_wake_detection_environment_parsing(self):
        ...
        for env_value, expected in test_cases:
            with patch.dict(os.environ, {
                ...
                assert config.wake.enabled == expected, f"Failed for env value: {env_value}"
