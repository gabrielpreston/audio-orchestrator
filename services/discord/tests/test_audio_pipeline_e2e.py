...
from services.discord.audio import AudioSegment, AudioPipeline
...
class TestAudioPipelineE2E:
    ...
    async def test_audio_pipeline_happy_path(self, mock_config, mock_logger, sample_audio_segment, 
                                      mock_transcription_client, mock_wake_detector, mock_orchestrator_client):
        ...
        with patch('services.discord.discord_voice.TranscriptionClient', return_value=mock_transcription_client), \
             patch('services.discord.discord_voice.WakeDetector', return_value=mock_wake_detector), \
             patch('services.discord.discord_voice.OrchestratorClient', return_value=mock_orchestrator_client):
    ...
    @pytest.mark.component
    def test_audio_pipeline_with_wake_detection(self, mock_config, mock_logger, sample_audio_segment,
                                              mock_transcription_client, mock_wake_detector):
    ...
    @pytest.mark.component
    def test_audio_pipeline_without_wake_detection(self, mock_config, mock_logger, sample_audio_segment,
                                                 mock_transcription_client, mock_wake_detector):
    ...
    @pytest.mark.component
    async def test_audio_pipeline_stt_circuit_open(self, mock_config, mock_logger, sample_audio_segment,
    ...
    @pytest.mark.component
    async def test_audio_pipeline_correlation_id_propagation(self, mock_config, mock_logger, sample_audio_segment,
                                                       mock_transcription_client, mock_wake_detector):
    ...
    @pytest.mark.component
    async def test_audio_pipeline_debug_artifacts_generated(self, mock_config, mock_logger, sample_audio_segment,
                                                    mock_transcription_client, mock_wake_detector):
    ...
    @pytest.mark.component
    async def test_audio_pipeline_error_handling(self, mock_config, mock_logger, sample_audio_segment,
                                          mock_transcription_client):
    ...
    @pytest.mark.component
    async def test_audio_pipeline_logging_sequence(self, mock_config, mock_logger, sample_audio_segment,
                                           mock_transcription_client, mock_wake_detector):
    ...
    @pytest.mark.component
    async def test_audio_pipeline_performance_metrics(self, mock_config, mock_logger, sample_audio_segment,
                                               mock_transcription_client, mock_wake_detector):
