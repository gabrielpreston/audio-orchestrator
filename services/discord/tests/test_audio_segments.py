...
from services.discord.audio import AudioPipeline, AudioConfig, Accumulator, FlushDecision
...
class TestAudioSegments:
    ...
    def test_segment_creation_generates_correlation_id(self, audio_pipeline, sample_accumulator, mock_logger):
        """Test that segment creation generates a correlation ID."""
        # Add some frames to the accumulator
        sample_accumulator.append(Mock(pcm=b"frame1", timestamp=0.0, rms=1000.0, duration=0.030, sequence=1, sample_rate=16000))
        sample_accumulator.append(Mock(pcm=b"frame2", timestamp=0.030, rms=1000.0, duration=0.030, sequence=2, sample_rate=16000))
        
        # Mock the correlation ID generation
        with patch('services.common.correlation.generate_discord_correlation_id', return_value="test-correlation-123"):
            segment = audio_pipeline._flush_accumulator(
                sample_accumulator,
                decision=FlushDecision(action="flush", reason="silence_timeout", silence_age=0.75, total_duration=0.06),
    ...
    def test_segment_ready_logs_all_metadata(self, audio_pipeline, sample_accumulator, mock_logger):
        ...
        segment_ready_calls = [call for call in mock_logger.info.call_args_list if call[0][0] == "voice.segment_ready"]
    ...
    @pytest.mark.component
    def test_segment_binds_correlation_id_to_logger(self, audio_pipeline, sample_accumulator, mock_logger):
    ...
    @pytest.mark.component
    def test_segment_flush_on_silence_timeout(self, audio_pipeline, sample_accumulator, mock_logger):
    ...
    @pytest.mark.component
    def test_segment_creation_with_override_reason(self, audio_pipeline, sample_accumulator, mock_logger):
    ...
    @pytest.mark.component
    def test_segment_creation_with_no_decision(self, audio_pipeline, sample_accumulator, mock_logger):
    ...
    @pytest.mark.component
    def test_segment_creation_empty_accumulator(self, audio_pipeline, sample_accumulator, mock_logger):
        ...
        with patch('services.common.correlation.generate_discord_correlation_id', return_value="test-correlation-123"):
            segment = audio_pipeline._flush_accumulator(
                sample_accumulator,
                decision=FlushDecision(action="flush", reason="silence_timeout", silence_age=0.75, total_duration=0.0),
                trigger="silence_check",
                timestamp=0.75
            )
    ...
    def test_segment_metadata_accuracy(self, audio_pipeline, sample_accumulator, mock_logger):
        ...
        frame1 = Mock(pcm=b"frame1", timestamp=0.0, rms=1000.0, duration=0.030, sequence=1, sample_rate=16000)
        frame2 = Mock(pcm=b"frame2", timestamp=0.030, rms=1200.0, duration=0.030, sequence=2, sample_rate=16000)
        frame3 = Mock(pcm=b"frame3", timestamp=0.060, rms=800.0, duration=0.030, sequence=3, sample_rate=16000)
        ...
        with patch('services.common.correlation.generate_discord_correlation_id', return_value="test-correlation-123"):
            segment = audio_pipeline._flush_accumulator(
                sample_accumulator,
                decision=FlushDecision(action="flush", reason="silence_timeout", silence_age=0.75, total_duration=0.09),
                trigger="silence_check",
                timestamp=0.75
            )
