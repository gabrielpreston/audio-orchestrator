...
class TestDebugWAV:
    ...
    def mock_config(self, temp_debug_dir):
        ...
        telemetry_config = TelemetryConfig(
            waveform_debug_dir=temp_debug_dir
        )
    ...
    @pytest.mark.component
    def test_save_debug_wav_uses_correlation_id(self, voice_bot, sample_audio_segment, temp_debug_dir):
    ...
    def test_save_debug_wav_skips_when_dir_not_set(self, voice_bot, sample_audio_segment):
        ...
        def mock_save_debug_wav(segment, prefix="segment"):
            ...
            assert False, "Should not create file when debug dir is not set"
    ...
    @pytest.mark.component
    def test_save_debug_wav_handles_write_errors(self, voice_bot, sample_audio_segment, temp_debug_dir):
    ...
    @pytest.mark.component
    def test_captured_segment_saves_debug_wav(self, voice_bot, sample_audio_segment, temp_debug_dir):
