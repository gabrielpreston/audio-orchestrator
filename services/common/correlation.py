...
def generate_orchestrator_correlation_id(
    ...
    return CorrelationIDGenerator.generate_orchestrator_correlation_id(source_correlation_id, user_id)
...
def generate_mcp_correlation_id(
    ...
    return CorrelationIDGenerator.generate_mcp_correlation_id(source_correlation_id, client_name, tool_name)
