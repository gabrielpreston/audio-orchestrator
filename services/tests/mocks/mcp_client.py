...
class MockMCPTool:
    ...
    async def call(self, parameters: Dict[str, Any], correlation_id: Optional[str] = None) -> Dict[str, Any]:
        """Call the tool."""
        call_data = {
            "parameters": parameters,
            "correlation_id": correlation_id
...
def create_mock_weather_tool() -> MockMCPTool:
    ...
    async def weather_handler(parameters: Dict[str, Any], correlation_id: Optional[str] = None) -> Dict[str, Any]:
...
def create_mock_discord_tool() -> MockMCPTool:
    ...
    async def discord_handler(parameters: Dict[str, Any], correlation_id: Optional[str] = None) -> Dict[str, Any]:
...
def create_mock_voice_tool() -> MockMCPTool:
    ...
    async def voice_handler(parameters: Dict[str, Any], correlation_id: Optional[str] = None) -> Dict[str, Any]:
        """Mock voice handler."""
    ...
    return create_mock_mcp_tool(
        "voice_control",
        "Control voice channel operations",
        parameters,
        voice_handler
    )