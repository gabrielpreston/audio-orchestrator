...
class Settings(BaseSettings):
    ...
    db_url: str = Field(
        default="sqlite+aiosqlite:///./audio_orchestrator.db",
    ...
    stt_service_url: Optional[str] = Field(
        default=None,
        description="URL for external STT service"
    )
    tts_service_url: Optional[str] = Field(
        default=None,
        description="URL for external TTS service"
    )
    
    # Orchestrator Configuration
    default_adapter: str = Field(
        default="discord",
        description="Default I/O adapter to use"
    )
